...
export const sendPaymentConfirmationEmail = async (req, res) => {
  const { userEmail,patientName,psychologistEmail, PsychologistName, appointmentDate, appointmentTime, razorpay_payment_id } = req.body;
  ...
  `;
    ...
    await transporter.sendMail({
      ...
      to: "rb9470218@gmail.com", //put ${userEmail}
 ...
 await transporter.sendMail({
  from: "innerisland4@gmail.com", // Replace with your Gmail account
  to: "rb9470218@gmail.com", //put ${psychologistEmail}
  subject: "Appointment Confirmation",
  text: userEmailContent,                           
});
