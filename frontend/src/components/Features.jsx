const Feature = () => {
  return (
    <div className="container">
      <div
        className="flex-lg-row d-flex flex-column justify-content-center align-items-center w-100 justify-content-lg-between"
        style={{ height: "80vh" }}
      >

        <div className="d-flex flex-row gap-5 gap-lg-5  w-lg-50 col-12 col-lg-4 justify-content-center align-items-center mb-2  justify-content-lg-between">
